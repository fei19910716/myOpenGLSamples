...
{
    Matrix4f CameraTranslationTrans, CameraLookAtTrans;

    CameraTranslationTrans.InitTranslationTransform(-m_camera.Pos.x, -m_camera.Pos.y, -m_camera.Pos.z);
    CameraLookAtTrans.InitCameraLookAtTransform(m_camera.Target, m_camera.Up);

    m_Vtransformation = CameraLookAtTrans * CameraTranslationTrans;
