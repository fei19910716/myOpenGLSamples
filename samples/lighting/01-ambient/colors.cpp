...
constexpr const glm::vec3 lightColor(0.5f, 0.5f, 0.5f);
constexpr const glm::vec3 objectColor(0.0f, 0.5f, 0.0f);
...
private:
    ...
    void CreateShader(){
        lightingShader = new Technique("shaders/1.lighting.vs","shaders/1.lighting.fs");
        lightCubeShader = new Technique("shaders/1.light_cube.vs","shaders/1.light_cube.fs");
    }
