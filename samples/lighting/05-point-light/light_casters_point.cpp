...
public:
    ...
    void RenderSceneCB() override
    {
        ...
        // also draw the lamp object
         lightCubeShader->Enable();
         lightCubeShader->SetUniformVec3("lightColor", light.Color);
         lightCubeShader->SetUniformMat4("projection", projection);
         lightCubeShader->SetUniformMat4("view", view);
         model = glm::mat4(1.0f);
         model = glm::translate(model, light.Position);
         model = glm::scale(model, glm::vec3(0.1f)); // a smaller cube
         model = glm::rotate(model, (float)(0.2 * glfwGetTime()), glm::vec3(0.5f, 1.0f, 0.0f));
...
private:
    ...
    void CreateShader(){
        lightingShader =  new Technique("shaders/5.2.lighting.vs","shaders/5.2.lighting.fs");
        lightCubeShader = new Technique("shaders/5.2.light_cube.vs","shaders/5.2.light_cube.fs");
    }
