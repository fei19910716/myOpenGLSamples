...
private:
    ...
    void CreateShader(){
        lightingShader =  new Technique("shaders/5.1.lighting.vs","shaders/5.1.lighting.fs");
        lightCubeShader = new Technique("shaders/5.1.light_cube.vs","shaders/5.1.light_cube.fs");
    }
